* 概要
  Emacs 30.0.50 用 音楽ファイルのタグ修正 lisp 関数集です.
...
* このセットのバージョン
  番号で管理する能力がないので [Oct 26 2024] 版とします.
...
* 追加情報
  wtag 用再生ツール [[https://gist.github.com/s-fubuki/1de0bb7cddab734631743c15054ccd3b][shuffle-all.el]] を 2軍登録したので、興味があれば見てみてください.
